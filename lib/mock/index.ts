 ...
 * EXPORTS: mockClients, mockHorses, mockStalls, mockTasks, mockBillingLineItems, mockDocuments, mockClientDocuments, mockStableSettings, mockInvoices
 * DEPENDS ON: ./clients, ./horses, ./stalls, ./tasks, ./billing, ./documents, ./clientDocuments, ./settings, ./invoices
 * CONSUMED BY: All module hooks
 * TESTS: None (re-export only)
 * LAST CHANGED: 2026-03-06 — Added settings and invoices exports for Phase 7b
 */
