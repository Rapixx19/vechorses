 ...
 * ZONE: Green
 * PURPOSE: Dashboard page content with loading timeout, error handling, and widgets
 * EXPORTS: DashboardPage
 * DEPENDS ON: modules/horses, modules/clients, modules/stalls, modules/billing, modules/staff, modules/calendar
 * CONSUMED BY: app/dashboard/page.tsx
 * TESTS: modules/dashboard/tests/DashboardPage.test.tsx
 * LAST CHANGED: 2026-03-08 — Extracted from app/dashboard/page.tsx for SSR fix
 */
...
import { HorsesGlance } from "./HorsesGlance"
