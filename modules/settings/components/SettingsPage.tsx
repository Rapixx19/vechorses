/**
 * FILE: modules/settings/components/SettingsPage.tsx
 * ZONE: 🔴 Red
 * PURPOSE: Settings page content with tabs for stable info, billing, history, team, and WhatsApp
 * EXPORTS: SettingsPage
 * DEPENDS ON: modules/billing, modules/clients, TeamManager, WhatsAppSettings
 * CONSUMED BY: app/settings/page.tsx
 * TESTS: modules/settings/tests/SettingsPage.test.tsx
 * LAST CHANGED: 2026-03-08 — Extracted from app/settings/page.tsx for SSR fix
 */
